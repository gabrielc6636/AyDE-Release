...
$mail->addAddress('rcp.desarrollo@gmail.com', 'Desarrolladores');
//Asunto
$mail->Subject = '[Desarrolladores] Recordatorio de carga';

//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body

$mail->msgHTML(file_get_contents('recordatorioCarga.html'), dirname(__FILE__));
